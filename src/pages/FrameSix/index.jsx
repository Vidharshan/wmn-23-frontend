...
const FrameSixPage = () => {
  return (
    <>
      <div className="bg-blue_gray_100 h-[900px] mx-auto pt-[5px] px-[5px] relative w-full">
        ...
        <div className="absolute font-helvetica h-[900px] inset-y-[0] my-auto md:px-5 right-[1%] w-[70%] md:w-full">
          <div className="h-[900px] m-auto w-full">
            <Img
              src="images/img_1_900x1008.png"
        ...
        <Text
          className="absolute bottom-[6%] font-helvetica leading-[110.00%] left-[5%] text-white_A700 tracking-[-1.20px] uppercase"
          as="h1"
          variant="h1"
        >
          <>
        ...
        <Text
          className="absolute font-inter leading-[100.00%] left-[3%] text-white_A700 top-[12%] tracking-[-1.20px]"
          as="h1"
          variant="h1"
        >
          <>
